                        ...
                        if (isApp || isPage) {
                            for (const dep of entry.dependencies){
                                ...
                                if (isApp && entryMod.request) {
                                    ...
                                    const resource = ((_loaderQuery_get = loaderQuery.get("pagePath")) == null ? void 0 : _loaderQuery_get.replace("private-next-app-dir", _path.default.join(this.appDir, "app"))) || "";
                    ...
                    if (!(binding == null ? void 0 : binding.isWasm) && typeof binding.turbo.startTrace === "function") {
                        ...
                        this.turbotraceContext.entriesTrace = {
                            action: {
                                ...
                                input: chunks,
                                contextDirectory,
                                processCwd: ((_this_turbotrace1 = this.turbotrace) == null ? void 0 : _this_turbotrace1.processCwd) ?? this.appDir,
