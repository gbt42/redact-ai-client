...
const _requirehook = require("./webpack/require-hook");
...
async function copyTracedFiles(dir, distDir, pageKeys, appPageKeys, tracingRoot, serverConfig, middlewareManifest) {
    ...
    for (const page of Object.values(middlewareManifest.functions)){
        ...
        for (const file of [
            ...
            const originalPath = _path.default.join(distDir, file.filePath);
            const fileOutputPath = _path.default.join(outputPath, _path.default.relative(tracingRoot, distDir), file.filePath);
            await _fs.promises.mkdir(_path.default.dirname(fileOutputPath), {
                recursive: true
            });
            await _fs.promises.copyFile(originalPath, fileOutputPath);
