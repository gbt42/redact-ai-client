...
const _getpreloadedfontfilesinlinelinktags = require("./get-preloaded-font-files-inline-link-tags");
   ...
   */ const generateStaticHTML = supportsDynamicHTML !== true;
     ...
     */ const getDynamicParamFromSegment = (// [slug] / [[slug]] / [...slug]
        ...
        const getLayerAssets = ({ layoutOrPagePath , injectedCSS: injectedCSSWithCurrentLayout , injectedFontPreloadTags: injectedFontPreloadTagsWithCurrentLayout  })=>{
            ...
            const preloads = /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, (preloadedFontFiles == null ? void 0 : preloadedFontFiles.length) === 0 ? /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/ _react.default.createElement("link", {
            ...
            const styles = stylesheets ? stylesheets.map((href, index)=>/*#__PURE__*/ _react.default.createElement("link", {
                    rel: "stylesheet",
                    // In dev, Safari and Firefox will cache the resource during HMR:
                    // - https://github.com/vercel/next.js/issues/5860
                    // - https://bugs.webkit.org/show_bug.cgi?id=187726
            ...
            return {
                Component: ()=>{
                    return /*#__PURE__*/ _react.default.createElement(_react.default.Fragment, null, isPage && isClientComponent && isStaticGeneration ? /*#__PURE__*/ _react.default.createElement(StaticGenerationSearchParamsBailoutProvider, {
                        ...
                        Component: Component
                    }) : /*#__PURE__*/ _react.default.createElement(Component, props), preloads);
                },
                styles
            };
        };
