                    ...
                    if (!_constant.ALLOWED_EXPORTS.includes(name.text) && !API_DOCS[name.text]) {
                        ...
                        if (value && options) {
                            ...
                            if (ts.isStringLiteral(value) || ts.isNoSubstitutionTemplateLiteral(value)) {
                                const text = (0, _utils.removeStringQuotes)(value.getText());
                                const allowedValues = Object.keys(options).filter((v)=>/^['"]/.test(v)).map(_utils.removeStringQuotes);
                                ...
                                if (((_API_DOCS_name_text_isValid = (_API_DOCS_name_text = API_DOCS[name.text]).isValid) == null ? void 0 : _API_DOCS_name_text_isValid.call(_API_DOCS_name_text, v)) === false) {
                                    isInvalid = true;
                                    displayedValue = v;
                                }
                                ...
                                const v = value.getText();
                                if (((_API_DOCS_name_text_isValid1 = (_API_DOCS_name_text1 = API_DOCS[name.text]).isValid) == null ? void 0 : _API_DOCS_name_text_isValid1.call(_API_DOCS_name_text1, v)) === false) {
                                    isInvalid = true;
                                    displayedValue = v;
                                }
