        ...
        const catchAllRoute = {
            ...
            fn: async (req, res, _params, parsedUrl)=>{
                ...
                if (this.isRouterWorker) {
                    ...
                    const renderKind = ((_this_appPathRoutes = this.appPathRoutes) == null ? void 0 : _this_appPathRoutes[page]) ? "app" : "pages";
                    ...
                    if (renderWorker) {
                        ...
                        for (const [key, value] of Object.entries((0, _serveripc.filterReqHeaders)({
                            ...invokeRes.headers
                        }))){
                            if (value !== undefined) {
                                if (key === "set-cookie") {
