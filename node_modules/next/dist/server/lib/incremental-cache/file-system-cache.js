...
class FileSystemCache {
    ...
    async get(key, fetchCache) {
        ...
        if (data && (data == null ? void 0 : (_data_value = data.value) == null ? void 0 : _data_value.kind) === "FETCH") {
            var _innerData_tags;
            this.loadTagsManifest();
            const innerData = data.value.data;
            const isStale = (_innerData_tags = innerData.tags) == null ? void 0 : _innerData_tags.some((tag)=>{
            ...
            if (isStale) {
                data.lastModified = Date.now() - _constants.CACHE_ONE_YEAR;
            }
        }
        return data || null;
    }
