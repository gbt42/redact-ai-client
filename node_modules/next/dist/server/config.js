...
const experimentalWarning = (0, _utils.execOnce)((configFileName, features)=>{
    ...
    if (features.includes("appDir")) {
        _log.info(`Thank you for testing \`appDir\` please leave your feedback at https://nextjs.link/app-feedback`);
    }
    console.warn();
});
function setHttpClientAndAgentOptions(config, silent = false) {
    ...
    if (isAboveNodejs16) {
        ...
        if (((_config_experimental1 = config.experimental) == null ? void 0 : _config_experimental1.enableUndici) && !isAboveNodejs18) {
            var _config_experimental2;
            globalThis.__NEXT_USE_UNDICI = (_config_experimental2 = config.experimental) == null ? void 0 : _config_experimental2.enableUndici;
        }
    } else if (((_config_experimental = config.experimental) == null ? void 0 : _config_experimental.enableUndici) && !silent) {
        _log.warn(`\`enableUndici\` option requires Node.js v${NODE_16_VERSION} or greater. Falling back to \`node-fetch\``);
    }
...
function assignDefaults(dir, userConfig, silent = false) {
    var _result_experimental, _result_experimental1, _result_experimental2, _result_experimental3, _result_experimental4, _result_devIndicators;
    ...
    if ((_result_experimental1 = result.experimental) == null ? void 0 : _result_experimental1.appDir) {
    ...
    if (typeof ((_result_experimental2 = result.experimental) == null ? void 0 : _result_experimental2.swcMinifyDebugOptions) !== "undefined") {
        if (!silent) {
