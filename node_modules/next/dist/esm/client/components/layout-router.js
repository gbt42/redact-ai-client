    ...
    constructor(...args){
        ...
        this.handlePotentialScroll = ()=>{
            ...
            if (focusAndScrollRef.apply) {
                ...
                if (focusAndScrollRef.segmentPaths.length !== 0 && !focusAndScrollRef.segmentPaths.some((segmentPath)=>segmentPath.length === this.props.segmentPath.length && segmentPath.every((segment, index)=>matchSegment(segment, this.props.segmentPath[index])))) {
                    return;
                }
                let domNode = null;
