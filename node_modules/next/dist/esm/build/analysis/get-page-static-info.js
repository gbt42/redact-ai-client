 ...
 */ export async function getPageStaticInfo(params) {
    ...
    if (/runtime|getStaticProps|getServerSideProps|export const config/.test(fileContent)) {
        ...
        if (pageType === "app") {
            if (config) {
                Log.warnOnce(`\`export const config\` in ${pageFilePath} is deprecated. Please change it to segment export config. See https://beta.nextjs.org/docs/api-reference/segment-config`);
                config = {};
            }
        }
        if (!config) config = {};
