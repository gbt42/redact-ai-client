    ...
    try {
        const [[verifyResult, typeCheckEnd]] = await Promise.all([
            ...
            shouldLint && nextBuildSpan.traceChild("verify-and-lint").traceAsyncFn(async ()=>{
                var _config_eslint;
                await verifyAndLint(dir, eslintCacheDir, (_config_eslint = config.eslint) == null ? void 0 : _config_eslint.dirs, config.experimental.workerThreads, telemetry, isAppDirEnabled && !!appDir);
            })
        ]);
