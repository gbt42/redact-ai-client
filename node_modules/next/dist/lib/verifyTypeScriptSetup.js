...
const _writeVscodeConfigurations = require("./typescript/writeVscodeConfigurations");
...
async function verifyTypeScriptSetup({ dir , distDir , cacheDir , intentDirs , tsconfigPath , typeCheckPreflight , disableStaticImages , isAppDirEnabled , hasPagesDir  }) {
    ...
    try {
        ...
        await (0, _writeConfigurationDefaults.writeConfigurationDefaults)(ts, resolvedTsConfigPath, intent.firstTimeSetup, isAppDirEnabled, distDir, hasPagesDir);
